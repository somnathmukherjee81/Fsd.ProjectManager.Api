...
namespace Fsd.ProjectManager.Api.Helpers
{
    ...
    internal static class Configuration
    {
        ...
        public static string DbConnectionString => GetValue(
            ...
            "Server=(localdb)\\mssqllocaldb;Database=ProjectManagerDb;Trusted_Connection=True;MultipleActiveResultSets=true");

        /// <summary>
        /// Gets the DatabaseName
        /// Database Name.
        /// </summary>
        public static string DatabaseName => GetValue("DB_NAME", "ProjectManagersDb");
